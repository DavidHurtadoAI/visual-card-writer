...
- Draw subtle, non-spacing directional arrows from each card to its first visible child; the arrows point right in horizontal mode and down in vertical mode.
